...
%   \begin{tabularx}{\textwidth}{|>{\ttfamily\raggedright\arraybackslash}p{0.31\textwidth}|>{\raggedright\arraybackslash}X|}
%     \hline
%     \rowcolor{RTOSBlue}\multicolumn{1}{|c|}{\color{white}\bfseries\sffamily Semaphore / Queue} & \multicolumn{1}{c|}{\color{white}\bfseries Purpose}     \\
%     \hline
%     sensor\_ready\_sem                                                                         & Signals that a new sensor sample is available.          \\
%     \hline
%     lcd\_sem                                                                                   & Signals that LCD data are ready to display.             \\
%     \hline
%     heater\_sem                                                                                & Activates the heater task.                              \\
%     \hline
%     cooler\_sem                                                                                & Activates the cooler task.                              \\
%     \hline
%     humidifier\_sem                                                                            & Activates the humidifier task.                          \\
%     \hline
%     cooler\_finished\_sem                                                                      & Signals that the cooler has completed its cycle.        \\
%     \hline
%     humidifier\_finished\_sem                                                                  & Signals that the humidifier has completed its sequence. \\
%     \hline
%   \end{tabularx}
% \end{center}
